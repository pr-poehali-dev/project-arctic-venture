  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Студия дизайна интерьеров · Москва
        </p>
        ...
        >
          Дом, в котором
          <span className="block text-sage">хочется быть</span>
        </h1>
        ...
        >
          Мы создаём пространства, где японская тишина встречается со скандинавским уютом. Без лишнего — только то, что по-настоящему важно для вашей жизни.
        </p>
